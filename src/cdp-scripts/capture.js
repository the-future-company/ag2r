// capture.js — Main snapshot capture script
// Runs inside Antigravity browser via CDP Runtime.evaluate
// Helpers prepended at load time: tagInteractives, untagAll, findChatContainer
(async () => {
  ...
  // -- 16. Capture portal elements (dropdowns, dialogs) from body --
  ...
  // -- 17. Capture Settings modal (rendered inside #root, not body) --
  ...
  // -- 18. Detect active tab URI for commenting --
  ...
  // -- 19. Detect and capture permission/approval banner --
  ...
  // -- 20. Extract environment/worktree and branch from new session bottom bar --
  ...
  // -- 21. Extract model name from model selector button --
  let modelName = null;
  try {
